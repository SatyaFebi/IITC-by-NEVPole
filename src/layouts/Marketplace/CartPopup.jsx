    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            ...
            >
                {/* Close Button */}
                <button
                    className="absolute top-3 right-3 text-secondary font-bold text-xl"
                    onClick={handleClose}
                >
                    ✖
                </button>
                ...
                <p className="text-xs text-gray-500 mb-4">
                    Harga belum termasuk PPN, Harga hanya produk yang kamu
                    pilih. Silakan Lanjut ke pembayaran untuk konfirmasi.
                </p>
                ...
                {cartItems.length === 0 ? (
                    ...
                    <div className="mb-4">
                        {cartItems.map((item) => (
                            ...
                            >
                                <div className="flex flex-row justify-between w-full my-1 mr-1">
                ...
                <div className="flex items-center justify-between mt-4">
                    <div className="flex items-center">
                        <p className="font-semibold">Total</p>
                        <p className="ml-2 text-secondary font-semibold">
                            Rp {calculateTotal().toLocaleString()}
                        </p>
                    </div>
                    <button
                        className="bg-secondary hover:bg-primary transition-colors duration-150 text-white font-semibold px-3 py-2 rounded-lg"
